...
struct instrumentView: View {
    ...
    @State private var currentVideoURL: String = "https://www.youtube.com/embed/VkcqdK4daLE"
            ...
            ZStack{
                ...
                HStack(spacing: 60) {
                    Rectangle()
                        ...
                        .clipped()
                        .overlay(
                            Image("صوره الربابه") // Replace "your_image_name" with the actual name of your image asset
                                .resizable()
